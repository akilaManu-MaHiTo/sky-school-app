                    ...
                    <Table size="small">
                      <TableHead>
                        <TableRow>
                          ...
                          <TableCell align="right">Overall Class Average Mark</TableCell>
                          <TableCell align="right">Highest Class Mark</TableCell>
                          <TableCell align="right">Highest Class Grade</TableCell>
                        </TableRow>
                      </TableHead>
                      <TableBody>
                        {(report.subjects ?? []).map(
